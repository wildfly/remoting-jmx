# Contributing to Remoting JMX

Welcome to the Remoting JMX project! We welcome contributions from the community. This guide will walk you through the steps for getting started on our project.
...
The Remoting JMX project uses JIRA to manage issues. All issues can be found [here](https://issues.redhat.com/projects/REMJMX/issues).
...
### Good First Issues
Want to contribute to the Remoting JMX project but aren't quite sure where to start? Look for issues with the `good-first-issue` label. These are a triaged set of issues that are great for getting started on our project. These can be found [here](https://issues.redhat.com/issues/?jql=project%20%3D%20REMJMX%20and%20labels%3Dgood-first-issue%20ORDER%20BY%20key%20DESC).
...
```
git remote add upstream https://github.com/wildfly/remoting-jmx
```
...
```bash
git checkout -b REMJMX-9999
```

To build `remoting-jmx` run:
```bash
mvn clean install
```
...
1. In general, it's good practice to squash all of your commits into a single commit. For larger changes, it's ok to have multiple meaningful commits. If you need help with squashing your commits, feel free to ask us how to do this on your pull request. We're more than happy to help!
  ...
  1. Please include the JIRA issue you worked on in the title of your pull request and in your commit message. For example, for [REMJMX-9999](https://issues.redhat.com/browse/REMJMX-9999), the PR title and commit message should be `[REMJMX-9999] Create a testcase which verifies behaviour of the foo`.

2. Please include the link to the JIRA issue you worked on in the description of the pull request. For example, if your PR adds a fix for [REMJMX-9999](https://issues.redhat.com/browse/REMJMX-9999), the PR description should contain a link to https://issues.redhat.com/browse/REMJMX-9999.
